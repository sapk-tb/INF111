/**
 * je suis un Produit. j'obtiens un numero et un name a ma creation <br>
 * Ma classe (Produit) garde le namebre numberCreated de produits crees.
 * 
 * <br>
 * un produit sait : <br>
 * - etre cree <br>
 * - donner son numero <br>
 * - donner son name <br>
 * - s'imprimer <br>
 * la classe produit sait : <br>
 * - donner le nombre numberCreated de produits crees <br>
...
public class Produit {
	...
	/**
	 * @param name
	 *            le name du nouveau Produit cree, et m'attribue un numero
	...
	public Produit(String name, Producteur producteur) {
		this.name = name;
	...
	public String toString() {
		if (producteur == null)
			...
			return "Produit : " + name + "  number : " + number + "  producteur : " + producteur.getName();
	}
